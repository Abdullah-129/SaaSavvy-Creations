                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-3">
                                    <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                        ...
                                        <li class="nav-item border rounded mb-1">
                                            <a class="nav-link" id="openai-tab" data-toggle="tab" href="#openaiTab" role="tab" aria-controls="openaiTab" aria-selected="true">{{__('admin.Open AI')}}</a>
                                        </li>
                                ...
                                <div class="col-12 col-sm-12 col-md-9">
                                    <div class="border rounded">
                                        <div class="tab-content no-padding" id="settingsContent">
                                                ...
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-logo-favicon') }}" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Logo One')}}</label>
                                                                <div>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Logo Two')}}</label>
                                                                <div>
                                            ...
                                            <div class="tab-pane fade" id="openaiTab" role="tabpanel" aria-labelledby="openai-tab">
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-open-ai') }}" method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Open AI Key')}}</label>
                                                                @if (env('APP_MODE') == 'DEMO')
                                                                    <input type="text" name="open_ai_key" class="form-control" value="open-ai-test-api-key" required>
                                                                @else
                                                                    <input type="text" name="open_ai_key" class="form-control" value="{{ $setting->open_ai_key }}" required>
                                                                @endif
                                                    ...
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-tawk-chat') }}" method="POST">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="chat_link" id="" cols="30" rows="10" class="form-control text-area-5">{{ $tawkChat->chat_link }}</textarea>
