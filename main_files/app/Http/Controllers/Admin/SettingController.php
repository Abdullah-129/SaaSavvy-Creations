...
class SettingController extends Controller
{
    ...
    public function index(){
        ...
        return view('admin.setting',compact('setting','cookieConsent','googleRecaptcha','facebookComment','tawkChat','googleAnalytic','customPaginations','socialLogin','facebookPixel','currencies','selected_theme'));
    }
    ...
    public function updateOpenAi(Request $request){
        $setting = Setting::first();
        $setting->open_ai_key = $request->open_ai_key;
        $setting->save();
